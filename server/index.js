...
const SESSION_SECRET_OPT = process.env.SESSION_SECRET; // utilisé comme signal .env présent si besoin
if (!SESSION_SECRET_OPT && process.env.NODE_ENV === "production") {
  console.warn(
    "[getInnr] Avertissement: définissez SESSION_SECRET en production (.env)."
  );
}
